...
class AppContext:
    ...
    @property
    def custom_sources_config(self) -> Dict:
        """获取自定义数据源配置"""
        return self.config.get("CUSTOM_SOURCES", {})

    @property
    def custom_twitter_config(self) -> Dict:
        """获取 Twitter 自定义源配置"""
        return self.custom_sources_config.get("TWITTER", {})

    @property
    def twitter_enabled(self) -> bool:
        """Twitter 趋势抓取是否启用"""
        return self.custom_twitter_config.get("ENABLED", False)
